...
void u::Setup()
{
	...
	colors[ImGuiCol_TitleBg] = ImVec4(0.40f, 0.00f, 0.80f, 1.00f);
	colors[ImGuiCol_TitleBgActive] = ImVec4(0.40f, 0.00f, 0.80f, 1.00f);
	colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.00f, 0.00f, 0.00f, 0.51f);
	colors[ImGuiCol_MenuBarBg] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
	colors[ImGuiCol_ScrollbarBg] = ImVec4(0.02f, 0.02f, 0.02f, 0.53f);
	colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.40f, 0.00f, 0.80f, 1.00f);
	colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.41f, 0.41f, 0.41f, 1.00f);
	colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.51f, 0.51f, 0.51f, 1.00f);
	colors[ImGuiCol_CheckMark] = ImVec4(0.40f, 0.00f, 0.80f, 1.00f);
	colors[ImGuiCol_SliderGrab] = ImVec4(0.40f, 0.00f, 0.80f, 1.00f);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(0.40f, 0.00f, 0.80f, 1.00f);
...
void u::Render()
{
	...
	case 0:
	{
		...
		ImGui::Text("Rage:");
		HelpMarker("Rage Aim Options");
		ImGui::Separator();

		ImGui::Checkbox("silent aim", &v::aim.aimbot);
		if (v::aim.aimbot)
		{
			ImGui::SliderInt("fov", &v::misc.fov, 0, 50, "%0.1f", 0);
		}
		ImGui::EndChild();
		ImGui::EndGroup();
	}
	...
	case 1:
		...
		VISUALS_COLOR_BOOL(weapName);
		VISUALS_COLOR_BOOL(headdot);
		VISUALS_COLOR_BOOL(skeleton);
		VISUALS_COLOR_BOOL(snaplines);
		ImGui::EndChild();
	...
	case 4:
	{
		...
		ImGui::Text("version:");
		ImGui::SameLine();
		ImGui::TextDisabled("v1.1 beta");
		ImGui::Text("author:");
		ImGui::SameLine();
		ImGui::TextDisabled("cazz & lxcid (the paster)");
